...
$sql_cek = "SELECT * FROM relasi WHERE kd_paket='$TxtKdPenyakit' AND kd_pilihan='$TxtKdGejala'";
...
$sqltes = "SELECT * FROM gejala WHERE kd_pilihan='$TxtKdGejala'";
$qrytes = mysql_query($sqltes, $koneksi);
while ($data_tmp = mysql_fetch_array($qrytes)){

$sql  = " INSERT INTO relasi (no_relasi,kd_paket,kd_pilihan,bobot) VALUES ('$TxtKdPenyakit','$TxtKdPenyakit','$TxtKdGejala','$bobot')"; 
}
