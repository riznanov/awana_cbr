...
$sqlrs=mysql_query("SELECT kd_vendor FROM data_vendor WHERE kd_vendor='$kd_vendor'");
$rs=mysql_num_rows($sqlrs);
if($rs==0){
	// jika data nol maka simpan data
	$perintah="INSERT INTO data_vendor (kd_vendor,nama_vendor) VALUES ('','$vendor')";
	...
	if ($berhasil){
		...
		header("location: haladmin.php?top=datavendor.php");
		}else{
