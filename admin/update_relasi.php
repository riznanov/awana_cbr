...
$kd_paket=$_POST['TxtKdPenyakit'];
$kd_pilihan=$_POST['TxtKdGejala'];
$bobot=$_POST['txtbobot'];
$query=mysql_query("UPDATE relasi SET kd_paket='$kd_paket',kd_pilihan='$kd_pilihan',bobot='$bobot' WHERE id_relasi='$id_relasi'")or die(mysql_error());
if($query){
